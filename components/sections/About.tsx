                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
                    ...
                    <div className="lg:col-span-5 flex">
                        <div className="relative w-full p-6 sm:p-8 rounded-2xl bg-neutral-900/60 backdrop-blur-xl border border-neutral-800 shadow-2xl space-y-6 hover:border-cyan-500/50 transition-all duration-300 flex flex-col justify-between">
                                ...
                                <div className="space-y-5">
                                    {quickInfo.map((item, idx) => (
                                        <div key={idx} className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <p className="text-xs uppercase tracking-wider text-neutral-400 font-medium">{item.label}</p>
                                                <p className="text-sm sm:text-base text-neutral-100 font-semibold">{item.value}</p>
                            ...
                            <div className="absolute -bottom-20 -left-30 w-48 h-48 bg-indigo-600/15 rounded-full blur-2xl pointer-events-none"></div>
                        </div>
                    </div>
