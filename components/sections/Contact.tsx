...
export default function Contact() {
    ...
    return (
        <section id="contact" className="relative font-paragraph min-h-screen py-24 lg:py-32 overflow-hidden">
            <div className="absolute top-1/2 left-1 md:top-1/3 md:left-1/5 w-full max-w-[750px] h-[400px] bg-indigo-600/15 blur-2xl md:blur-[80px] transform-gpu rounded-full pointer-events-none -z-10" />
            ...
            <div className="container mx-auto px-6 sm:px-12 max-w-7xl relative z-10 space-y-12 lg:space-y-16">
                <div className="space-y-4 max-w-3xl">
                    ...
                    <div className="mt-8 bg-neutral-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8">
                        <form action={process.env.NEXT_PUBLIC_FORM_URL} method="POST" className="flex flex-col gap-6">

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="flex flex-col">
                                    <label htmlFor="name" className="font-body text-xs text-white uppercase tracking-wider mb-2">
                                        Name
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="flex flex-col">
                                    <label htmlFor="email" className="font-body text-xs text-white uppercase tracking-wider mb-2">
                                        Email
                                    </label>
                                    <input
                                        type="email"
                            ...
                            <div className="flex flex-col">
                                <div className="flex justify-between items-center mb-2">
                                    <label htmlFor="message" className="font-body text-xs text-white uppercase tracking-wider">
                                        Message
                                    </label>
